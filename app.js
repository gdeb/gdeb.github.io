...
Elm.App.make = function (_elm) {
   ...
   $Content$About = Elm.Content.About.make(_elm),
   $Content$Home = Elm.Content.Home.make(_elm),
   $Content$Posts = Elm.Content.Posts.make(_elm),
   $Content$Projects = Elm.Content.Projects.make(_elm),
   $Content$Undefined = Elm.Content.Undefined.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Elements = Elm.Elements.make(_elm),
   ...
   var renderElements = F2(function (location,
   ui) {
      return function () {
         switch (location.ctor)
         {case "About":
            return $Content$About.render(ui);
            case "Home":
            return $Content$Home.render(ui);
            case "Posts":
            return $Content$Posts.render(ui);
            case "Projects":
            return $Content$Projects.render(ui);
            case "Undefined":
            return $Content$Undefined.render(ui);}
   ...
   model) {
      return function () {
         var elements = A2(renderElements,
         model.location,
         model.ui);
         var mainContent = _L.fromArray([A2($Html.div,
         ...
         return function () {
            ...
            {case "Desktop":
               return A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("desktop")]),
                 _L.fromArray([$Elements.sidebar(model.location)
                              ,A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("main-content")]),
                              mainContent)]));
               case "Mobile":
               return A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("mobile")]),
                 mainContent);}
            _U.badCase($moduleName,
   ...
   var UpdateUI = function (a) {
      return {ctor: "UpdateUI"
             ,_0: a};
   };
   var UpdatePath = function (a) {
      return {ctor: "UpdatePath"
             ,_0: a};
   };
   ...
   $Routes.pathSignal);
   var initialWidth = Elm.Native.Port.make(_elm).inbound("initialWidth",
   "Int",
   function (v) {
   ...
   var init = function () {
      var model = A2(Model,
      $Routes.getRoute(initialPath),
      $Layout.getUI(initialWidth));
      return {ctor: "_Tuple2"
             ,_0: model
             ,_1: $Effects.none};
   }();
   var app = function () {
      var uis = A2($Signal.map,
      UpdateUI,
      $Layout.uis);
      var paths = A2($Signal.map,
      UpdatePath,
      $Routes.locations);
      return $StartApp.start({_: {}
                             ,init: init
                             ,inputs: _L.fromArray([paths
                                                   ,uis])
                             ,update: update
                             ,view: view});
   }();
...
Elm.Content.About = Elm.Content.About || {};
Elm.Content.About.make = function (_elm) {
   "use strict";
   _elm.Content = _elm.Content || {};
   _elm.Content.About = _elm.Content.About || {};
   if (_elm.Content.About.values)
   return _elm.Content.About.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Content.About",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Layout = Elm.Layout.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var view = _L.fromArray([A2($Html.h1,
                           _L.fromArray([]),
   ...
   _elm.Content.About.values = {_op: _op
                               ,render: render
                               ,view: view};
   return _elm.Content.About.values;
};
Elm.Content = Elm.Content || {};
Elm.Content.Home = Elm.Content.Home || {};
Elm.Content.Home.make = function (_elm) {
   "use strict";
   _elm.Content = _elm.Content || {};
   _elm.Content.Home = _elm.Content.Home || {};
   if (_elm.Content.Home.values)
   return _elm.Content.Home.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Content.Home",
   $Basics = Elm.Basics.make(_elm),
   $Elements = Elm.Elements.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Layout = Elm.Layout.make(_elm),
   ...
   var view = _L.fromArray([A2($Html.h1,
                           ...
                           ,A2($Html.p,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("This is a work in progress")]))]);
   var render = function (ui) {
      return {_: {}
             ,content: view
             ,footer: $Elements.footer
             ,header: _L.fromArray([$Html.text("Home")])};
   };
   _elm.Content.Home.values = {_op: _op
                              ,render: render
                              ,view: view};
   return _elm.Content.Home.values;
};
Elm.Content = Elm.Content || {};
Elm.Content.Posts = Elm.Content.Posts || {};
Elm.Content.Posts.make = function (_elm) {
   "use strict";
   _elm.Content = _elm.Content || {};
   _elm.Content.Posts = _elm.Content.Posts || {};
   if (_elm.Content.Posts.values)
   return _elm.Content.Posts.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Content.Posts",
   $Basics = Elm.Basics.make(_elm),
   $Elements = Elm.Elements.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Layout = Elm.Layout.make(_elm),
   ...
   var view = _L.fromArray([A2($Html.h1,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("Posts")]))
                           ,A2($Html.div,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("aaaa")]))
                           ,A2($Html.div,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("aaaa")]))
                           ,A2($Html.div,
   ...
   _elm.Content.Posts.values = {_op: _op
                               ,render: render
                               ,view: view};
   return _elm.Content.Posts.values;
};
Elm.Content = Elm.Content || {};
Elm.Content.Projects = Elm.Content.Projects || {};
Elm.Content.Projects.make = function (_elm) {
   "use strict";
   _elm.Content = _elm.Content || {};
   _elm.Content.Projects = _elm.Content.Projects || {};
   if (_elm.Content.Projects.values)
   return _elm.Content.Projects.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Content.Projects",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Layout = Elm.Layout.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var view = _L.fromArray([A2($Html.h1,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("Projects")]))
                           ,A2($Html.p,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("content")]))]);
   var render = function (ui) {
   ...
   _elm.Content.Projects.values = {_op: _op
                                  ,render: render
                                  ,view: view};
   return _elm.Content.Projects.values;
};
Elm.Content = Elm.Content || {};
Elm.Content.Undefined = Elm.Content.Undefined || {};
Elm.Content.Undefined.make = function (_elm) {
   "use strict";
   _elm.Content = _elm.Content || {};
   _elm.Content.Undefined = _elm.Content.Undefined || {};
   if (_elm.Content.Undefined.values)
   return _elm.Content.Undefined.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Content.Undefined",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Layout = Elm.Layout.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Routes = Elm.Routes.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var header = _L.fromArray([$Html.text("Error 404")]);
   var view = _L.fromArray([A2($Html.h1,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("Wrong url")]))
                           ,A2($Html.p,
                           _L.fromArray([]),
                           ...
                           ,A2($Html.p,
                           _L.fromArray([]),
                           _L.fromArray([$Html.text("May I suggest that you click on one of these links?")]))
                           ,A2($Html.div,
                           _L.fromArray([]),
                           _L.fromArray([A2($Html.button,
                                        _L.fromArray([$Routes.linkTo($Routes.Home)]),
                                        _L.fromArray([$Html.text("Home")]))
                                        ,A2($Html.button,
                                        _L.fromArray([$Routes.linkTo($Routes.About)]),
                                        _L.fromArray([$Html.text("About")]))
                                        ,A2($Html.button,
                                        _L.fromArray([$Routes.linkTo($Routes.Posts)]),
                                        _L.fromArray([$Html.text("Posts")]))]))]);
   var render = function (ui) {
      return {_: {}
             ,content: view
   ...
   _elm.Content.Undefined.values = {_op: _op
                                   ,render: render
                                   ,view: view
                                   ,header: header};
   return _elm.Content.Undefined.values;
...
Elm.Elements = Elm.Elements || {};
Elm.Elements.make = function (_elm) {
   "use strict";
   _elm.Elements = _elm.Elements || {};
   if (_elm.Elements.values)
   return _elm.Elements.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Routes = Elm.Routes.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var footer = _L.fromArray([$Html.text("© 2015 Géry Debongnie, all rights reserved.")]);
   var sidebar = function (current) {
      return function () {
         var isActive = function (location) {
            return _U.eq(location,
            current) ? _L.fromArray([$Html$Attributes.$class("active")]) : _L.fromArray([]);
         };
         var makeListItem = F2(function (location,
         descr) {
            return A2($Html.li,
            A2($Basics._op["++"],
            _L.fromArray([$Routes.linkTo(location)]),
            isActive(location)),
            _L.fromArray([A2($Html.a,
            _L.fromArray([$Html$Attributes.href($Routes.getUrl(location))]),
            _L.fromArray([$Html.text(descr)]))]));
         });
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("sidebar")]),
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.$class("title")
                                   ,$Routes.linkTo($Routes.Home)]),
                      _L.fromArray([$Html.text("gdeb")]))
                      ,A2($Html.ul,
                      _L.fromArray([]),
                      _L.fromArray([A2(makeListItem,
                                   $Routes.About,
                                   "about")
                                   ,A2(makeListItem,
                                   $Routes.Posts,
...
Elm.Layout.make = function (_elm) {
   ...
   var Mobile = {ctor: "Mobile"};
   var Desktop = function (a) {
      return {ctor: "Desktop"
             ,_0: a};
   };
   var getUI = function (width) {
      return _U.cmp(width,
      1000) < 0 ? Mobile : Desktop(width);
   };
   var uis = $Signal.dropRepeats($Signal.map(getUI)($Window.width));
...
Elm.Routes.make = function (_elm) {
   ...
   var Undefined = {ctor: "Undefined"};
   var Projects = {ctor: "Projects"};
   ...
   var locations = A2($Signal.map,
   getRoute,
   $History.path);
   var pathChangeMailbox = $Signal.mailbox($Task.succeed({ctor: "_Tuple0"}));
   var pathSignal = pathChangeMailbox.signal;
   var pathAddress = pathChangeMailbox.address;
   var linkTo = function (location) {
      return $Html$Events.onClick(pathAddress)($History.setPath(getUrl(location)));
   };
